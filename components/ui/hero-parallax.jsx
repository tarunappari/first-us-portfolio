...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white font-clash">
        Transform Your Business <br /> with First Us
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 font-manrope">
...
export const ProductCard = ({ product, translate, isPriority = false }) => {
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-satoshi font-semibold">
        {product.title}
      </h2>
    </motion.div>
  );
