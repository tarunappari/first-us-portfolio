...
const LifeAtCompany = () => {
  ...
  const cultureHighlights = [
    {
      ...
      description: 'We encourage creative thinking and provide the freedom to explore new technologies and methodologies.'
    },
    {
      id: 2,
      title: 'Continuous Learning',
      description: 'Access to training programs, conferences, and certifications to keep your skills cutting-edge.'
    },
    {
      id: 3,
      title: 'Work-Life Harmony',
      description: 'Flexible schedules, remote work options, and wellness programs that support your personal life.'
    },
    {
      id: 4,
  ...
  const teamImages = [
    ...
    {
      id: 2,
      src: '/images/team/innovation-lab.jpg',
    ...
    {
      id: 4,
      src: '/images/team/remote-work.jpg',
      alt: 'Remote work setup',
      title: 'Remote Flexibility'
    },
    {
      id: 5,
      src: '/images/team/learning-session.jpg',
    ...
    },
    {
      ...
      alt: 'Team celebration and success',
  ...
  return (
    <section className={styles.lifeAtCompanySection} ref={sectionRef}>
      ...
      <div className={styles.backgroundElements}>
        <div className={`${styles.gradientOrb1} ${styles.floatingElement}`}></div>
        <div className={`${styles.gradientOrb2} ${styles.floatingElement}`}></div>
        <div className={`${styles.techPattern} ${styles.floatingElement}`}></div>
        <div className={`${styles.glowingLine1} ${styles.floatingElement}`}></div>
        <div className={`${styles.glowingLine2} ${styles.floatingElement}`}></div>
      </div>
          ...
          <div className={styles.leftColumn} ref={leftColumnRef}>
            <div className={styles.textContent}>
              ...
              <p className={styles.sectionDescription}>
                Join a dynamic team where innovation meets collaboration. We foster an environment 
                where creativity thrives, learning never stops, and every team member contributes 
